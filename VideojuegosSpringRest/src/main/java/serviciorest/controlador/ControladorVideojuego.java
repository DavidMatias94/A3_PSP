...
public class ControladorVideojuego {
	...
	public ResponseEntity<Videojuego> altaVideojuego(@RequestBody Videojuego p) {
		...
		List<Videojuego> listaVideojuegos = daoVideojuego.listById(p.getId());
		List<Videojuego> listaVideojuegos2 = daoVideojuego.listByName(p.getNombre());
		
		if (!listaVideojuegos.isEmpty()  || !listaVideojuegos2.isEmpty() ) {
